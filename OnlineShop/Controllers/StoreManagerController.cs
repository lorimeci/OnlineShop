...
{
    /*kemi autorizuar vetem kte user qe ti beje ndryshimet*/
    ...
    public class StoreManagerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemId,Title,CategoryId,ProducerId,Price,ItemArtUrl")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemId,Title,CategoryID,ProducerId,Price,ItemArtUrl")] Item item)
        {
            if (ModelState.IsValid)
            {
